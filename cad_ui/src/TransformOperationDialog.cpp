...
namespace cad_ui {
    ...
    void TransformOperationDialog::setupRotationTab() {
        ...
        m_axisZButton->setChecked(true); // Use the Z axis by default
        ...
        m_angleDegrees->setChecked(true); // Use degrees by default
        ...
        // Connect all signals for rotation parameter changes
    ...
    void TransformOperationDialog::setupScaleTab() {
        ...
        // Connect signals for scale parameter changes
    ...
    void TransformOperationDialog::onObjectSelectionClicked() {
        if (m_selectingObjects) {
            // If selection is in progress, this click completes it
